<?php
/**
 * Security e-Drift — hardened subscribe endpoint (optional).
 *
 * Loaded only if required from functions.php. Do not enable if the live theme
 * or an MU-plugin already registers edrift/v1/subscribe (duplicate routes conflict).
 *
